...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('product.create') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="imagem" name="imagem" required class="w-full border-gray-300 p-2">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="url" id="link" name="link" required class="w-full border-gray-300 rounded-md p-2">
        </div>
